...
const SharedReportView: React.FC = () => {
    ...
    useEffect(() => {
        const fetchReport = async () => {
            ...
            try {
                const reportRef = doc(db, 'SharedReports', reportId);
    ...
    if (loading) return <div className="text-center p-12">Đang tải báo cáo...</div>;
    if (error) return <div className="text-center p-12 text-red-600 font-semibold">{error}</div>;
...
root.render(<React.StrictMode><SharedReportView /></React.StrictMode>);